            ...
            return (
              ...
              >
                <Image
                  ...
                  alt="Carousel image"
                />
                <div className="sm:w-full xl:w-[910px] h-[112px] flex flex-col gap-5 justify-around *:px-5 rounded-md  items-center bg-black opacity-75 text-white absolute xl:left-[50px] bottom-[20px] ">
                  <div className="text-[#ff7119] mt-2">{el.name}</div>
                  <div className="w-[80%] mb-5 overflow-hidden">
                    {el.description}
                  </div>
                </div>
              </div>
