...
export const Header = ({ switchHeader }: any) => {
 ...
 ${switchHeader ? "flex" : "hidden"}
    ...
    >
      ...
      <div className="container sm:flex justify-around xl:text-xl md:text-[16px] sm:text-[12px] items-center sm:w-[600px] md:w-[800px]  xl:w-[1147px] border-b p-7 hidden">
