...
export const InfoAimag = () => {
  return (
    <div className=" w-full flex justify-center items-center mt-5 sm:mt-20 ">
      <div className="w-full sm:w-[1000px] sm:h-[200px] border-b-[#FF6C10] sm:pb-0 pb-3 border-b flex justify-around sm:justify-between items-center gap-2 sm:gap-7 overflow-hidden">
        {BayanKhongorInfo.map((el, i): JSX.Element => {
          return (
            ...
            >
              ...
              <div className="flex sm:items-start  h-full sm:text-[17px] text-[5px]">
                {" "}
                <div>{el.title}</div>
              </div>
            </div>
