...
export const VideoArea = () => {
  ...
  return (
    <div className="w-full h-[280px] sm:h-[1000px] flex items-center flex-col">
      <div className="flex sm:w-[1147px] sm:ml-[150px] sm:mt-20 w-full mt-10 ">
      ...
      <div className="w-full sm:h-[183px] h-[80px] bg-[#ff7119] mt-5 sm:mt-10 flex justify-center items-start">
        <div className="w-full sm:w-[1320px] flex justify-start ">
          <div className="flex items-center w-full h-[fit] gap-[55px]  mt-[130px] ">
            <div className="sm:w-[1130px] sm:h-[420px] w-full ">
              {" "}
