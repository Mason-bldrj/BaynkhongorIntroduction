  ...
  return (
    <div className="max-w-[1147px] max-h-[600px] h-[100%] m-auto w-[95%] mt-10 flex flex-col gap-10 mb-10">
      ...
      <div className="w-full text-sm sm:text-md leading-[30px] sm:leading-[50px]">
        ...
        18:00 цагуудаас том оврын автобус Баянхонгор аймаг руу явдаг. {<br/>}-БАЯНХОНГОР
        аймгийн Тээврийн биржээс өдөр бүрийн - 08:00 цаг - 14:00 цаг - 18:00
        цагуудаас том оврын автобус Улаанбаатар хот руу явдаг.{<br/>}-Баянхонгор аймгийн
